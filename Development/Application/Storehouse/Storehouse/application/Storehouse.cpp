...
// Storehouse.cpp : Определяет поведение классов для приложения.
//

#include "stdafx.h"
#include "Storehouse.h"
#include "../main/StorehouseDlg.h"
...
BEGIN_MESSAGE_MAP(CStorehouseApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// создание CStorehouseApp

CStorehouseApp::CStorehouseApp()
{
...
// Единственный объект CStorehouseApp

CStorehouseApp theApp;


// инициализация CStorehouseApp

BOOL CStorehouseApp::InitInstance()
{
